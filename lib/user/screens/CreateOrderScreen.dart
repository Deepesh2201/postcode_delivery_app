...
class CreateOrderScreenState extends State<CreateOrderScreen> {
  ...
  String getWeightText(int totalWeight) {
    if (totalWeight == 1) {
      return 'Extra Small';
  ...
  getTotalAmount() {
    ...
    if (weightController.text.toDouble() > cityData!.minWeight!) {
      ...
      weightCharge = ((weightController.text.toDouble()) * cityData!.perWeightCharges!).toStringAsFixed(digitAfterDecimal).toDouble();
    }
    ...
    return Observer(builder: (context) {
      return Column(
        ...
        children: [
          ...
          16.height,
          Text('Select Parcel Size', style: boldTextStyle()),
          8.height,
          Container(
            decoration: BoxDecoration(
              border: Border.all(
            ...
            child: Row(
              children: [
                ...
                DropdownButton<int>(
                  value: int.parse(weightController.text),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Box Size', style: primaryTextStyle()),
                  16.width,
                  Text('${getWeightText(weightController!.text!.toInt())}', style: primaryTextStyle()),
                ],
              ),
              8.height,
              Row(
