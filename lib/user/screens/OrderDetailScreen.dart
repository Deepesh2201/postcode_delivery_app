          ...
          child: Stack(
            ...
            Container(
              decoration: BoxDecoration(
                color: appStore.isDarkMode ? scaffoldSecondaryDark : colorPrimary.withOpacity(0.05),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          4.height,
                          Text(
                            // 'Box Size : ${getWeightText(orderData!.totalWeight!.toInt())}',
                            'Box Size : ${orderData!.parcelSize}',
                            style: secondaryTextStyle(),
                          ),
                        ],
                      ).expand(),
          ...
          24.height,
                              ...
                              (orderData!.extraCharges!.runtimeType == List<dynamic>)
                                  ? OrderSummeryWidget(
                                      ...
                                      totalParcel: orderData!.totalParcel,
                                      parcelRate: orderData!.parcelRate,
                                    )
                                  : Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
