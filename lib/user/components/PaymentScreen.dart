...
import 'package:gogo_riders_delivery/user/components/webview_flutter.dart';
...
import '../../main/screens/PaystackScreen.dart';
// import '../../main/services/paystack_integration.dart';
                        ...
                        Align(
                          ...
                          child: commonButton(language.payNow, () {
                            if (selectedPaymentType == PAYMENT_TYPE_STRIPE) {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PaystackScreen(totalAmount: (widget.totalAmount * 100).toInt(),orderId: widget.orderId.toString(), payStackPublicKey: payStackPublicKey,)),
