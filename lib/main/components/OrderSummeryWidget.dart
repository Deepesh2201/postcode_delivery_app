...
class OrderSummeryWidget extends StatefulWidget {
  ...
  final num? totalParcel;
  final num? parcelRate;
  final String? status;
      ...
      children: [
        ...
        Column(
          children: [
            ...
            Row(
              children: [
                Text('Box Charges', style: primaryTextStyle()),
                4.width,
                Row(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    // Text('(${widget.totalParcel}', style: secondaryTextStyle()),
                    // Icon(Icons.close, color: Colors.grey, size: 12),
                    // Text('${widget.parcelRate})', style: secondaryTextStyle()),
                  ],
                ).expand(),
                16.width,
