class MobileUpdateResponse {
  UserData? data;
  String? message;
  var status;

  MobileUpdateResponse({this.data, this.message,this.status});

  factory MobileUpdateResponse.fromJson(Map<String, dynamic> json) {
    return MobileUpdateResponse(
