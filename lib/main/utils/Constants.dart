const mAppName = 'Efficient, Safe & Reliable';
const mPrivacyPolicy = 'https://gogoriders.ng/privacypolicy';
const mTermAndCondition = 'https://gogoriders.ng/termsandcondition';
const mHelpAndSupport = 'https://gogoriders.ng/contactus';
const mContactPref = 'https://gogoriders.ng/contactus';
// const mCodeCanyonURL = 'ADD_CODE_CANYON_URL';

/// Don't add slash at the end of the url
const DOMAIN_URL = 'https://backend.gogoriders.ng';
const mBaseUrl = "$DOMAIN_URL/api/";

const googleMapAPIKey = 'AIzaSyAYgPBnRH-wNT7rQcT09RGjxoMIHA6TL2o';

const mOneSignalAppId = '74cfeb86-9d68-4ed8-82ce-311dc5009dc8';
const mOneSignalRestKey = 'YzQ2NTY5YTgtY2YwMC00YjhlLTkwODctZWIxN2E5YjJlYTFl';
const mOneSignalChannelId = '7bf34490-bd11-4aee-bfac-e2c56d1611d3';
